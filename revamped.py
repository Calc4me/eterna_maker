...
temprange = [2,8] # Minimum [0]/2 stacks, maximum [1]/2 stacks
...
stdev = 2 # SD of stack lengths (option 0) 
...
conversionvars = {
    ...
    "maxposdiff": 1, # Max difference betweent the position of two unpaired bases to warrant removal between sides of a stack
...
while not stopFlag:
    ...
    while not generationContinueFlag:
        ...
        for i in range(len(pairslist)):
            ...
            stacktoinsert = convertstack.convertstack(stacksize,conversionvars["dotratio"],conversionvars["onechance"],conversionvars["twochance"],conversionvars["maxcountdiff"],conversionvars["maxposdiff"])
